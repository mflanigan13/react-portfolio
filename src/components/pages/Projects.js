...
export default function Projects() {
    return (
        <div>
            ...
            <div class="card">
                    <img src="/images/huntress-handcrafted.png" width={300} alt="Group Project 3" />
                    <div class="card-body">
                        <h3 class="card-title">Huntress Handcrafted</h3>
                        <p class="card-text">E-commerce website designed for Huntress Handcrafted Soap for class project.</p>
                        <div class="btn-wrapper">
                            <a href="https://github.com/BurnsD/HuntressHandcraftedSoap" class="btn btn-primary">GitHub</a>
                            <a href="https://infinite-shelf-01850.herokuapp.com/" class="btn btn-primary">Deployment</a>
                        </div>
                    </div>
                </div>
                <div class="card">
